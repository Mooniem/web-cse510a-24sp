...
import pathPhotoJeongyeob from '../assets/images/jeongyeob_photo.jpg';
...
>
    ...
    <Box marginTop={-2} marginBottom={-2} marginRight={2}>
        <p>Jeongyeob Hong</p>
        <p><img src={pathPhotoJeongyeob} height="150" alt="Photo of Katelyn Mei."/></p>
    </Box>
    <Box marginTop={-2} marginBottom={-2} marginRight={2}>
        <p>Katelyn Mei</p>
...
- __(20 points)__: Individual Assignments (IA)
  - __(5 points)__: Assignment 1, Intro and motivation
  - __(5 points)__: Assignment 2, Design process
  - __(5 points)__: Assignment 3, Design critique
  - __(5 points)__: Assignment 4, Testing
