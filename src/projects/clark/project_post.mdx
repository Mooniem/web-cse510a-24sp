...
<ProjectImagesBlock
    images={[
        {src: task1Step1Image1},
        {src: task1Step1Image2},
    ]}
    direction="row"
    width={8}
>
...
<ProjectImagesBlock
    images={[
        {src: task1Step2Image1},
        {src: task1Step2Image2},
        {src: task1Step2Image3},
        {src: task1Step2Image4},
    ]}
    direction="row"
    width={8}
>
...
<ProjectImagesBlock
    images={[
        {src: task1Step3Image1},
        {src: task1Step3Image2},
        {src: task1Step3Image3},
        {src: task1Step3Image4},
        {src: task1Step3Image5},
    ]}
    direction="column"
    width={8}
>
...
<ProjectImagesBlock
    images={[
        {src: task1Step4Image1},
        {src: task1Step4Image2},
    ]}
    direction="row"
    width={8}
>
...
<ProjectImageBlock image={{src: task2Step2Image1}} width={8}>
#### Step 2:
