...
import pathImprovingAccessibility from "./assets/post/ImprovingAccessibility.jpg";
import pathImprovingAudienceFeedback from "./assets/post/ImprovingAudienceFeedback.jpg";
import pathImprovingEditClarkOption from "./assets/post/ImprovingEditClarkOption.jpg";
...
<ProjectImageBlock image={{src: pathImprovingEditClarkOption}} width={4}>
...
<ProjectImageBlock image={{src: pathImprovingAudienceFeedback}} width={4}>
...
<ProjectImageBlock image={{src: pathImprovingAccessibility}} width={4}>
