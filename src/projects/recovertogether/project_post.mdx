...
# RecoverTogether: Recovery Done Right
...
>
    ...
    <Grid item>
        This interaction indicates one of our key tasks, which is where a provider can send appointment notes to a particular patient. Furthermore, the provider has added a rehab task, notes, and a demonstrational video relating to the rehab task for their patient, Levi Errol.
    </Grid>
    <Grid item>
        <img
            src={image4}
