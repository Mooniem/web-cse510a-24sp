...
# Buzzed - Moderate and support your own drinking experience.
...
export const task1StartingPageImages = [
    {
        img: task1StartingPageImage1,
        title: 'Alt',
        rows: 1,
        cols: 1,
    },
    {
        img: task1StartingPageImage2,
        title: 'Alt',
        rows: 1,
        cols: 1,
    },
    {
        img: task1StartingPageImage3,
        title: 'Alt',
        rows: 1,
        cols: 1,
    },
    {
        img: task1StartingPageImage4,
        title: 'Alt',
        rows: 1,
        cols: 1,
    },
...
<ImageList cols={4}>
    {task1StartingPageImages.map((item) => (
...
<Grid container spacing={2}>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1HealthyRecommendationsImage1}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1HealthyRecommendationsImage2}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={6}>
        <h4>Healthy Recommendations</h4>
...
<Grid container spacing={2}>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1TrackingDataImage1}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1TrackingDataImage2}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
...
<Grid container spacing={2}>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1AddDrinksImage}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
...
<Grid container spacing={2}>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1ContactFriendsImage1}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1ContactFriendsImage2}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={3}>
        <img
            src={`${task1ContactFriendsImage3}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={3}>
        <h4>Contact Friends</h4>
...
<Grid container spacing={2}>
    ...
    <Grid item xs={6} md={3}>
        <img
            src={`${task2Image3}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
    <Grid item xs={6} md={9}>
        <h4>Detailed statistic</h4>
        The summary page contains people’s prior tracking data on alcohol consumption.
    </Grid>
    <Grid item xs={6} md={3}>
        <img
            src={`${task2Image4}?auto=format`}
            width="100%"
            alt="Alt"
        />
    </Grid>
...
<Grid container spacing={4}>
    <Grid item>
        <TeamMemberCard name="Anna Shi" photo={pathPhotoAnna} />
    </Grid>

    <Grid item>
        <TeamMemberCard name="Judy Tian" photo={pathPhotoJudy} />
    </Grid>

    <Grid item>
        <TeamMemberCard name="Kristine Dao" photo={pathPhotoKristine}  />
    </Grid>

    <Grid item>
        <TeamMemberCard name="Silence Yang" photo={pathPhotoSilence}/>
    </Grid>
</Grid>
