...
<ProjectSubtitle>the purrfect cat helper</ProjectSubtitle>
...
<ProjectImagesBlock
    images={[
        {
            src: task1Image1,
            caption: "Select the “My Cats” tab.",
        },
        {
            src: task1Image2,
        ...
        {
            src: task1Image3,
            caption: "Input your cat's information.",
        },
    ]}
    direction="row"
    width={8}
...
<ProjectImagesBlock
    images={[
        {
            src: task1Image4,
            caption: "Tap the “Add Meal” button.",
        },
        {
            src: task1Image5,
            caption: "Customize meal settings.",
        },
        {
            src: task1Image6,
            caption: "Connect to a feeder.",
        },
    ]}
    direction="row"
    width={8}
...
<ProjectImagesBlock
    images={[
        {
            src: task2Image3,
            caption: "Add a personalized message.",
        },
        {
            src: task2Image4,
            caption: "Confirmed!",
