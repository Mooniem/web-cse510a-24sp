...
import path3pPresentationStaffForm from '../../../assets/assignments/3p-presentation-staff-form.pdf';
...
- [Assignment 3a: Paper Prototype](#id-3a-paper-prototype)
  ...
  <p><CourseInformationDueDate dueDateName='dueDateAssignment3a' /></p>

- [Assignment 3b: Heuristic Evaluation](#id-3b-heuristic-evaluation)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment3b' /></p>

- [Assignment 3c: Usability Testing Check-In](#id-3c-usability-testing-check-in)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment3c' /></p>

- [Assignment 3d: Usability Testing Review](#id-3d-usability-testing-review)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment3d' /></p>

- [Assignment 3e: Digital Mockup](#id-3e-digital-mockup)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment3e' /></p>

- [Assignment 3p: Presentation](#id-3p-presentation)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment3p' /></p>
...
<CollapseProjectMilestone heading='3a: Paper Prototype' dueDateName='dueDateAssignment3a'>
...
<p><CourseInformationLink linkName='linkCanvasAssignment3a' /></p>
...
<AssignmentSamples milestone='3a' />


</CollapseProjectMilestone>

<CollapseProjectMilestone heading='3b: Heuristic Evaluation' dueDateName='dueDateAssignment3b'>
...
<AssignmentSamples milestone='3b' />

</CollapseProjectMilestone>

<CollapseProjectMilestone heading='3c: Usability Testing Check-In' dueDateName='dueDateAssignment3c'>
...
<p><CourseInformationLink linkName='linkCanvasAssignment3c' /></p>
...
<AssignmentSamples milestone='3c' />

</CollapseProjectMilestone>

<CollapseProjectMilestone heading='3d: Usability Testing Review' dueDateName='dueDateAssignment3d'>
...
<p><CourseInformationLink linkName='linkCanvasAssignment3d' /></p>
...
<AssignmentSamples milestone='3d' />


</CollapseProjectMilestone>

<CollapseProjectMilestone heading='3e: Digital Mockup' dueDateName='dueDateAssignment3e'>
...
<p><CourseInformationLink linkName='linkCanvasAssignment3e' /></p>
...
<AssignmentSamples milestone='3e' />


</CollapseProjectMilestone>

<CollapseProjectMilestone heading='3p: Presentation' dueDateName='dueDateAssignment3p'>
...
- A six minute time limit will be strictly enforced, with additional time for questions.
...
<p><CourseInformationLink linkName='linkCanvasAssignment3p' /></p>
...
<p><a href={path3pPresentationStaffForm}>3p-presentation-staff-form.pdf</a></p>
...
<AssignmentSamples milestone='3p' />
